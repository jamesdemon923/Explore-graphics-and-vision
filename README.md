...
| [MIT Deep Learning Book](https://www.deeplearningbook.org/)  | MIT Deep Learning Book by Ian Goodfellow, Yoshua Bengio and Aaron Courville. |
...
| [Common 3D models](https://github.com/alecjacobson/common-3d-test-models) | Common 3D test models. Credit: [Alec Jacobson](https://www.cs.toronto.edu/~jacobson/) |
| [Computer Graphics Archive by McGuire](https://casual-effects.com/data/) | Test models for ray tracing. Credit: [Morgan McGuire](https://casual-effects.com/data/) |
| [Rendering Resources](https://benedikt-bitterli.me/resources/) | 32 different 3D scenes that can be used for free in rendering research, publications and classes. Credit: [Benedikt Bitterli](https://benedikt-bitterli.me/) |
|                       Siggraph Courses                       |                Courses organized by Siggraph                 |
| [Siggraph Annual Papers](https://kesen.realtimerendering.com/) | Annual Siggraph articles. Credit: [Ke-Sen Huang](https://kesen.realtimerendering.com/) |
